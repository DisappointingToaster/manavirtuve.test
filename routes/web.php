...
Route::get('/fridge',[recipe_controller::class,'fridge'])->middleware('auth');
Route::get('/recipes',[recipe_controller::class,'recipes']);
Route::get('/moderation',[main_route_handler::class,'moderation'])->middleware('auth');
...
Route::get('/moderation/editFilters',[recipe_controller::class,'modifyFilters'])->middleware('auth');
Route::post('/moderation/newCategory',[recipe_controller::class,'createCategory'])->middleware('auth');
Route::post('/moderation/newIngredient',[recipe_controller::class,'createIngredient'])->middleware('auth');
...
Route::delete('/moderation/ingredient/{ingredient}',[recipe_controller::class,'deleteIngredient'])->middleware('auth');
Route::delete('/moderation/category/{category}',[recipe_controller::class,'deleteCategory'])->middleware('auth');;
Route::post('/fridge',[recipe_controller::class,'fridgeIngredients'])->middleware('auth');
